...
contract BetToken is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x340c0086d7EC8fd129A49E43A2114791543Da6a6;
    ...
    constructor() public ERC20("BetToken", "Bet") {
...
contract BUSDDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("bet_Dividen_Tracker", "bet_Dividen_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 5000000 * (10**18); //must hold 5000000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "bet_Dividen_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "bet_Dividen_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BABYCAKE contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "bet_Dividen_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "bet_Dividen_Tracker: Cannot update claimWait to same value");
